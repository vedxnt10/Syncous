...
<head>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <h1>404</h1>
        <h2>You Entered the Wrong login Credentials.</h2>
        <p>Please Check if you entered wrong username and password or society code. <br>Maybe you are member and you tried to enter your login credentials in admin panel, or vise-versa.</p>
       
        <p>Try Again! Enter valid society code given by your admin
        </p>
        <div>
            <form action="home">
