    ...
    <body>
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <form action="admin_complaints" class="nav-link " >
                        <button type="submit"  class="sidebut">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <h5 style="font-size: 17px;">Username: <%=user[p]%></h5>
                                    <h5 style="font-size: 17px;">Flat No: <%=flat[p]%> </h5>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                This will give an appointment token (means his issue/complaint will be discussed in meeting) to selected society member
                                            </div>
