            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <form action="admin_home" class="nav-link collapsed" >
                        <button type="submit" class="collapsed sidebut">
                ...
                <li class="nav-item ">
                    <form action="admin_members" class="nav-link " >
        ...
        <main id="main" class="main">
            ...
            <section class="section profile">
                <div align="center" class="row">
                    <%for (int p = 0; p < i; p++) {%>
                    <div  class="col-xl-4">
                        <form action="admin_check_profile">
                            <input type="hidden" name="role" value="<%=role[p]%>">
                            <input type="hidden" name="flat" value="<%=flat[p]%>">
                            <button name="user" value="<%=username[p]%>" style="background: none;padding: 0;margin: 0; border: none; height: fit-content;">
                                <div class="card">
                                    <div class="card-body profile-card d-flex flex-column align-items-center">
                                        <i class="bi bi-person-fill" style="font-size: 5em;"></i>
                                        <h3><%=role[p]%></h3>
                                        <h3><%=flat[p]%></h3>
                                        <h2><%=username[p]%></h2>
                                        <h3><%=mail[p]%></h3>
