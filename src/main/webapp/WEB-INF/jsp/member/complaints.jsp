<%-- 
    Document   : complaints
    Created on : May 4, 2023, 6:03:38 PM
    Author     : Yash
--%>
...
<head>
    ...
    <title>Syncouse| Complaints</title>
    ...
    <!-- ======= Header ======= -->
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <form action="member_complaints" class="nav-link " >
                        <button type="submit"  class="sidebut">
    ...
    <main id="main" class="main">
        ...
        <section class="section profile">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 align="left" class="card-title">Post complaint</h5>
                        <form action="complaintprocess" class="">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="mb-3 col-lg-12 ">
                                    ...
                                    <div class="input-group has-validation">
                                        <textarea class="form-control border-black" name="message" style="height: 200px"
                                            placeholder="Description of announcement ( Not more than 500 letters)"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class=" d-flex justify-content-start btns mt-3 mb-3">
                                <button class="btn btn-outline-danger ms cfb" type="reset">Reset</button>
                                <button class="btn btn-outline-primary ms-3" type="submit">Post</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><%=mess[p]%></p>
                        <form action="delete_complaint">
                            <button type="button" class="btn btn-outline-success mb-3" data-bs-toggle="modal" data-bs-target="#basicModal">
                                Delete Post
                              </button>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                   This will delete your posted complaint which you selected just now
                                </div>
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
                                  <button type="submit" name="id" value="<%=idd[p]%>" class="btn btn-primary">Yes</button>
                                </div>
                              </div>
                            </div>
                        </form>
