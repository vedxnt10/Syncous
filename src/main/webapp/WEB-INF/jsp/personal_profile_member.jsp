...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <form action="member_personal_profile" class="nav-link ">
            ...
            <div class="row">
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRD9huB6D3e3Vpu7wH-6bBOBYDHS5MzP5ArBA&usqp=CAU" alt="Profile" class="rounded-circle">
                            <h2>@<%=user%></h2>
                            <h3 class="mt-2">Flat No <span class="gbg"><%=flat%></span> </h3>
                            <h3>Society Code <span  class="gbg"><%=sc%></span></h3>
                        </div>
                    </div>
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <ul class="nav nav-tabs nav-tabs-bordered">
                                ...
                                <li class="nav-item">
                                    <button class="nav-link active" data-bs-toggle="tab"
                                        data-bs-target="#profile-overview">Personal Information</button>
                                </li>

                                <li class="nav-item">
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Contact
                                        Details</button>
                                </li>
                            ...
                            <div class="tab-content pt-3 ">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Martial</div>
                                        <div class="col-lg-9 col-md-8"><%=martial%></div>
                                    </div>
                                ...
                                <div class="tab-pane fade profile-overview " id="profile-edit">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Flat No</div>
                                        <div class="col-lg-9 col-md-8"><%=flat%></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8"><%=district%></div>
                                    </div>
                        ...
                        <form action="Delete_account" class="nav-link collapsed">
                            <input type="hidden" name="user" value="<%=user%>" id="">
                            <input type="hidden" name="scode" value="<%=sc%>" id="">

                            <button type="button" class="btn btn-outline-secondary btn-rounded" data-bs-toggle="modal" data-bs-target="#basicModal" data-mdb-ripple-color="dark">
                                Delete Account
                            </button>
                    </div>                    
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Are your sure to delete this account? Your account with username <%=user%> will be deleted permanently from this society.
                                </div>
